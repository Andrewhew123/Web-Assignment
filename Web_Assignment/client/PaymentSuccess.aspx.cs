...
namespace Web_Assignment.client
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=.\SQLEXPRESS;ATTACHDbFilename=D:\shopping_website\App_Data\Galaxy.mdf;Integrated Security=True;User Instance=True");
        string order = "";
            ...
            if (order == Session["order_number"].ToString())
            {
                ...
                if (Request.Cookies["aa"] != null)
                {
                    ...
                    for (int i = 0; i < strArr.Length; i++)
                    {
                        ...
                        cmd3.CommandText = "insert into order_details values('" + order_orderId.ToString() + "','" + a[0].ToString() + "','" + a[2].ToString() + "','" + a[3].ToString() + "','" + a[4].ToString() + "')";
